...
double IntersectionCheck::check(Triangle &t1, Triangle &t2)
    {
...
std::optional<Point> IntersectionCheck::find_point_of_intersection(Line &line1, Line &line2) {
 ...
 std::vector<Point> IntersectionCheck::find_all_intersections(Triangle &t1, Triangle &t2) {
...
bool IntersectionCheck::is_point_in_triangle(const Point &p, const Triangle &t) {
...
bool IntersectionCheck::is_point_on_segment(const Point& intersection, const Line& line) {
